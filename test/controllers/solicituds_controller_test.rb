...
class SolicitudsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create solicitud" do
    assert_difference('Solicitud.count') do
      post solicituds_url, params: { solicitud: { comentarios: @solicitud.comentarios, computadores: @solicitud.computadores, descripcion: @solicitud.descripcion, estado: @solicitud.estado, expedicion: @solicitud.expedicion, nombredelevento: @solicitud.nombredelevento, numeroDeAsistentes: @solicitud.numeroDeAsistentes, videoBeam: @solicitud.videoBeam } }
    end
