...
class AdministradorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrador" do
    assert_difference('Administrador.count') do
      post administradors_url, params: { administrador: { clave: @administrador.clave, correo: @administrador.correo, nombre: @administrador.nombre } }
    end
  ...
  test "should update administrador" do
    patch administrador_url(@administrador), params: { administrador: { clave: @administrador.clave, correo: @administrador.correo, nombre: @administrador.nombre } }
